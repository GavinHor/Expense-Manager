...
const SideBar = (props) => {
  ...
  return (
    <div className={sidebarClass}>
      <nav class="sideCont">
      <Link to="/"> <button style={{width: "190px"}} onClick={handleClick}> Homepage </button> </Link>
      <Link to="/"> <button style={{width: "190px"}} onClick={handleClick}> My Information </button> </Link>
      <Link to="/"> <button style={{width: "190px"}} onClick={handleClick}> Claim Expense </button> </Link>
